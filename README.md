...
С JS и Frontend(ом) познакомился в 2017 году, но к концу года наши пути, к сожалению, разошлись. Вот в 2022 вернулся на эту иглу. Кайфую от сложных задач, кода без документации, компонентов на 500-1000 строк, новых непонятных библиотек/фреймворков, эльфов, орков и прочих извращений 
</br>
