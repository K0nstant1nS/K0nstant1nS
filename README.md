...
<h4>:curry: Фанатею по кулинарии
<h4>:trollface: Просто получаю удовольствие от жизни
<h4>:dollar: Готов работать за деньги(да)... :hamburger: Да и за еду... :yen: Да и за социальный рейтинг... :bulb: Да и за идею :relieved: </h4>
</br>
