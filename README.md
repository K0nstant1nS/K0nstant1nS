...
:curry: Фанатею по кулинарии</br>
:trollface: Просто получаю удовольствие от жизни</br>
:sunny: Готов работать за деньги(да)... :hamburger: Да и за еду... :yen: Да и за социальный рейтинг... :bulb: Да и за идею :relieved: 
</br>

<h3>В данный момент работаю над:</h3>
<ul>
<li> Небольшим расширение для перевода текста
<li> Бэк-проектом для Яндекс.Практикум.
</ul>
