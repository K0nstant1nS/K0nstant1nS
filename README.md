...
<h2>О себе:</h2>
:white_check_mark: Дней без пропуска коммитов: 11</br>
:runner: Занимаюсь спортом</br>
:curry: Фанатею от кулинарии</br>
:sun_with_face: Просто (не?) получаю удовольствие от жизни</br>
</br>
С JS и Frontend(ом) познакомился в 2018 году, но к концу года наши пути, к сожалению, разошлись. Вот в 2022 вернулся на эту иглу. Кайфую от сложных задач, кода без документации, компонентов на 500-1000 строк, новых непонятных библиотек/фреймворков, эльфов, орков и прочих извращений 
</br>

<h3>В данный момент работаю над:</h3>
<ul>
<li> Небольшие учебные проектики для знакомства с Vue
<li> Botkits. Там такооооооое...
</ul>
